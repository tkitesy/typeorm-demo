...
// CONCATENATED MODULE: ./src/entity/User.ts
...
let User = (_dec = Object(external_typeorm_["Entity"])(), _dec2 = Object(external_typeorm_["PrimaryGeneratedColumn"])(), _dec3 = Reflect.metadata("design:type", Number), _dec4 = Object(external_typeorm_["Column"])(), _dec5 = Reflect.metadata("design:type", String), _dec6 = Object(external_typeorm_["Column"])(), _dec7 = Reflect.metadata("design:type", String), _dec8 = Object(external_typeorm_["Column"])(), _dec9 = Reflect.metadata("design:type", Number), _dec(_class = (_class2 = (_temp = class User {
  constructor() {
...
Object(external_typeorm_["createConnection"])(options).then(async connection => {
...
/* harmony default export */ var hello = __webpack_exports__["default"] = ((req, res) => {
  res.statusCode = 200;
  res.json({
    name: 'John Doe'
  });
